(function () {
    ...
    app.controller('QuizController', ['$scope', '$http', '$sce', function ($scope, $http, $sce) {
        ...
        {
            var url = 'http://codifyndesign.com';
            var emailLink ='<a class="btn email" href="mailto:?subject=Try to beat my quiz score!&amp;body=I scored a '+percentage+'% on this quiz. Try to beat my score at '+url+'">Email a friend</a>';
